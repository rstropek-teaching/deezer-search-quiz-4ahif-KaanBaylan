...
window.onload = () => {
    ...
    const resultBody = document.getElementById('resultBody'), result = document.getElementById('result'), loading = document.getElementById('loading'), filter = document.getElementById('filter'), search = document.getElementById('search');
